...
from .tasks import send_welcome_email, print_purchase_count, print_user_count
...
def send_welcome_email_view(request):
    ...
    return task_result_view(request, result)


def print_purchase_count_view(request, user_id):
    result = print_purchase_count.delay(user_id)

    return task_result_view(request, result)


def print_user_count_view(request):
    result = print_user_count.delay()
